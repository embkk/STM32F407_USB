...
int IP_NI_KINETIS_Config_MSCR_MII_SPEED        (unsigned IFaceId, U8 v);
int IP_NI_KINETIS_Config_MSCR_DIS_PRE          (unsigned IFaceId, U8 v);
int IP_NI_KINETIS_Config_MSCR_HOLDTIME         (unsigned IFaceId, U8 v);
