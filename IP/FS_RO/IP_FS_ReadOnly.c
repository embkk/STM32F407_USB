...
//  -------------------                --------------                          -------------
  ...
  { "/Styles.css.gz",                  styles_file,                            STYLES_SIZE                      },
  ...
  { "/events.js.gz",                   events_file,                            EVENTS_SIZE                      },
#if INCLUDE_SHARE_SAMPLE
  ...
  { "/jquery.js.gz",                   jquery_file,                            JQUERY_SIZE                      },
  { "/RGraphCC.js.gz",                 rgraphcc_file,                          RGRAPHCC_SIZE                    },
  { "/RGraphCE.js.gz",                 rgraphce_file,                          RGRAPHCE_SIZE                    },
  { "/RGraphLi.js.gz",                 rgraphli_file,                          RGRAPHLI_SIZE                    },
#endif
#if INCLUDE_PRESENTATION_SAMPLE
