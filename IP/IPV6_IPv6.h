...
*/
//
// List of options which are enabled by default on an interface which uses IPv6.
//
...
const U8*           IP_IPV6_GetIPPacketInfo                    (const IP_PACKET* pPacket);
int                 IP_IPV6_IFaceIsReady                       (unsigned IFaceId);
int                 IP_IPV6_ParseIPv6Addr                      (const char* sHost, IPV6_ADDR* pIPv6Addr);
...
int                 IP_IPV6_DNS_SendDynUpdate                  (unsigned IFaceId, const char* sHost, const char* sDomain, U32 IPv4Addr, const U8* pIPv6Addr, int ClearPreviousRR, U32 ms);


//
// Multicast Listener related API functions
//
int                 IP_ICMPV6_MLD_AddMulticastAddr             (unsigned IFaceId, const IPV6_ADDR* pMultiCAddr);
int                 IP_ICMPV6_MLD_RemoveMulticastAddr          (unsigned IFaceId, const IPV6_ADDR* pIPv6Addr);
...
int                 IP_ICMPV6_SendEchoReq                      (unsigned IFaceId, const IPV6_ADDR* pDestAddr, const char* pData, unsigned NumBytes, U16 Id, U16 SeqNum);
