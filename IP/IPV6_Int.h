...
NDP_ENTRY*       IP_ICMPV6_NDP_FindNDPEntryByIP                (const IPV6_ADDR* pIPv6Addr);
...
int              IP_ICMPV6_NDP_SendNeighborSolicitationPacket  (unsigned IFaceId, const IPV6_ADDR* pDestIP);

//
// Multicast Listener Discovery (MLD) protocol
//
int              IP_ICMPV6_MLD_AddMulticastAddr_NoLock         (unsigned IFaceId, const IPV6_ADDR* pMultiCAddr);
...
int              IP_ICMPV6_MLD_RemoveMulticastAddr_NoLock      (unsigned IFaceId, const IPV6_ADDR* pIPv6Addr);
int              IP_ICMPV6_MLD_GenAndAddSolicitedNodeAddr      (unsigned IFaceId, const IPV6_ADDR* pIPv6Addr);
int              IP_ICMPV6_MLD_GenAndAddSolicitedNodeAddrEx    (unsigned IFaceId, const IPV6_ADDR* pIPv6Addr, unsigned UpdateFilters);
...
int              IP_ICMPV6_Send                                (IP_PACKET* pPacket, const IPV6_ADDR* pDestAddr);
void             IP_ICMPV6_GenCheckSum                         (IP_PACKET* pPacket, const IPV6_ADDR* pSrcAddr, const IPV6_ADDR* pDestAddr);
int              IP_ICMPV6_SendParaProbMsg                     (unsigned IFaceId, const IP_PACKET *pProbPacket, U8 Code, U32 Offset);
...
int                   IP_IPV6_Write                            (IP_PACKET* pPacket, U8 NextHeader, U8 HopLimit, const IPV6_ADDR* pDestIP);
void                  IP_IPV6_AddExtHeader                     (IP_PACKET* pPacket, U8 NextHeader, U8 ExtHeader, U8 Type, U16 Value);
...
IFACE*                IP_IPV6_LAddr2IFace                      (U32 PFamily, const void* pLHost);
IPV6_ADDR_DESC*       IP_IPV6_SelectSourceAddr                 (const IFACE* pIFace, const IPV6_ADDR* pDest, U8* pRouterReq);
IFACE*                IP_IPV6_GetIFaceForHost                  (const IPV6_ADDR* pAddr);
void                  IP_IPV6_Timer                            (void);
int                   IP_IPV6_RegenerateUnicastAddresses       (unsigned IFaceId);
//
// UDPv6
//
IP_UDP_CONNECTION* IP_IPV6_UDP_OpenEx_NoLock(const IPV6_ADDR* pFAddr, U16 FPort, const IPV6_ADDR* pLAddr, U16 LPort, int (*handler)(IP_PACKET* pPacket, void* pContext), void* pContext);
