...
**********************************************************************
-------------------------- END-OF-HEADER -----------------------------
Purpose : Transport Control Protocol related header file.
*/
...
TCPCB *  IP_TCP_PCB_lookupEx   (unsigned PFamily, void * pFAddr, U16 FPort, void * pLAddr, U16 LPort, int Flags, const IP_PACKET * pPacket);
...
// TCP functions
//
int      IP_TCP_AppendPacket      (SOCKET_BUFFER * sb, IP_PACKET * pPacket);
...
TCPCB  * IPV6_TCP_PCB_lookupEx   (unsigned PFamily, void* pFAddr, U16 FPort, void* pLAddr, U16 LPort, int Flags, const IP_PACKET* pPacket);
...
typedef struct {
  ...
  U32                  TxWindowSize;
  U32                  RxWindowSize;
  U32                  RxWinScale;       // Window Scaling Factor for TCP Window.
  U16                  NextFreePort;
} IP_TCP_GLOBAL;
